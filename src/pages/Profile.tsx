...
const ACTIVITY_LEVELS = [
  ...
  { value: 'extremely_active', label: 'Extremely Active (very hard exercise/training)' }
];
...
const COMMON_CONDITIONS = [
  ...
  'Thyroid Issues', 'PCOS', 'Heart Disease', 'Kidney Disease',
  'Liver Disease', 'Arthritis', 'Osteoporosis', 'Asthma',
  'Food Allergies', 'Digestive Issues', 'Anxiety', 'Depression'
];

const COMMON_ALLERGIES = [
  'Nuts', 'Dairy', 'Gluten', 'Soy', 'Eggs', 'Shellfish',
  'Fish', 'Sesame', 'Tomatoes', 'Onions', 'Garlic'
];

const INDIAN_CUISINES = [
  'North Indian', 'South Indian', 'Bengali', 'Gujarati', 'Punjabi',
  'Maharashtrian', 'Tamil', 'Kerala', 'Rajasthani', 'Hyderabadi',
  'Street Food', 'Continental', 'Chinese', 'Italian'
];
...
export default function Profile() {
  ...
  const saveProfile = async () => {
    ...
    try {
      const profileData = {
        ...
        diet: profile.diet_type as any, // Map to the correct field
  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Body Profile System (BPS)</h1>
      ...
      <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('age_years', parseInt(e.target.value) || undefined)}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('sleep_hours', parseFloat(e.target.value) || undefined)}
              ...
              {COMMON_CONDITIONS.map((condition) => (
                <div key={condition} className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={() => handleArrayToggle('conditions', condition)}
                  />
                  <Label
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                {INDIAN_CUISINES.map((cuisine) => (
                  <div key={cuisine} className="flex items-center space-x-2">
                    <Checkbox
                      id={`cuisine-${cuisine}`}
                      checked={(profile.cuisines || []).includes(cuisine)}
                      onCheckedChange={() => handleArrayToggle('cuisines', cuisine)}
                    />
                    <Label
        ...
        <Card>
          ...
          <CardContent>
            <Textarea
              value={profile.bps_notes || ''}
              onChange={(e) => handleInputChange('bps_notes', e.target.value)}
              placeholder="e.g., Recent surgery, medication side effects, specific dietary restrictions, fitness goals, etc."
              rows={4}
            />
          </CardContent>
        </Card>
